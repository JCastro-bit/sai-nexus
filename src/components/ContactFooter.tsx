...
const navigation = {
  servicios: [
    { name: 'Transporte Terrestre', href: '#' },
    { name: 'Almacenamiento', href: '#' },
    { name: 'Cadena de Suministro', href: '#' },
    { name: 'Rastreo GPS', href: '#' },
    { name: 'Carga Especializada', href: '#' },
  ],
  soporte: [
    { name: 'Rastrear Envío', href: '#' },
    { name: 'Centro de Ayuda', href: '#' },
    { name: 'Documentación', href: '#' },
    { name: 'Cotizar Servicio', href: '#' },
  ],
  empresa: [
    { name: 'Nosotros', href: '#' },
